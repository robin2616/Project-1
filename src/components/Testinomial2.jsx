...
function Testinomial2(){
    return(<>
    <div className=" w-[1440px] h-[672px] bg-black-200">
        ...
        <div className="w-[776px] absolute h-[100px] gap-0 opacity-[0px] left-[40px] rounded-8px bg-[#CCC1DA] top-[342px]">fsgs</div>
